...
"background-color:#CCFFCC")
        ...
        self.head_2.setText("")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(os.path.abspath("s1.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("insert.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"}")
        ...
        self.inputdate.setDateTime(QtCore.QDateTime(QtCore.QDate(2024, 8, 1), QtCore.QTime(0, 0, 0)))
...
"}")
        ...
        item.setFont(font)
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(os.path.abspath("s1.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon5)
        ...
        item.setFont(font)
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(os.path.abspath("s1.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon6)
        self.listWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        font = QtGui.QFont()
        ...
        item.setFont(font)
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(os.path.abspath("s1.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon7)
        self.listWidget.addItem(item)
        item = QtWidgets.QListWidgetItem()
        font = QtGui.QFont()
...
"border-radius:5px")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.sname.setText(_translate("MainWindow", "曹祥瑞"))
        self.ssex.setText(_translate("MainWindow", "男"))
        self.stime.setText(_translate("MainWindow", "2024-8-12"))
